...
public class UniformType {
    ...
    protected static final List<UniformType> TYPE_PRESET = new ArrayList<>(
        Arrays.asList(
    ...
    public UniformType deepClone() {
        ...
        if (subType == null) cloned.subType = null;
        else cloned.subType = subType.deepClone();
        return cloned;
    }
    ...
    public String toString() {
        ...
        builder.append(variant.getPrefix())
            .append(symbol);
        ...
        if (temp.kind == UniformTypeKind.ARRAY && temp.subType != null) {
            builder.append("[")
                .append(temp.arrayLength)
                .append("]");
            temp = temp.subType;
        }

        builder.append(" (")
            .append(temp.kind.toString())
            .append(")");
